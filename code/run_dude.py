...
if __name__ == '__main__':
    ...
    train1=pd.read_csv('../drug/DUDE/dataPre/DUDE-foldTrain3',sep=' ',header=None,index_col=None,names=['drug','target','label'])
    ...
    model1.train(train_data1, val = val_data1, test = test_data1, test_result='test_mode4_fold3')
