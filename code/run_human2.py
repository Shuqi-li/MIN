...
if __name__ == '__main__':
    ...
    parser.add_argument("--MLP_hidden_size_list_O", default=[512, 256, 64], type=int)
    ...
    model.train(train_data, val = val_data, test = test_data, test_result='test_mode1_score_en')
