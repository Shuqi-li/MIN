...
if __name__ == '__main__':
    ...
    testFoldPath = f"{this_dir}/DUDE/dataPre/DUDE-foldTest2"
    ...
    model_path = f"{this_dir}/result/test_mode1_fold2_score_en_t1d12/model.pt"
    ...
    np.save(f"{this_dir}/result/test_mode1_fold2_score_en_t1d12/test_result.npy", result)
